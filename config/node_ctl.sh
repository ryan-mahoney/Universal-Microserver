...
if [ $OPINE_ENV = "local" ]
    then
        ...
        cd /app/frontend && nodemon server.js --watch /home/app/frontend --exec babel-node --presets es2015,stage-0,stage-2,react |& /usr/bin/rotatelogs -n 3 /media/persistent/log/nodejs.log 86400
    else
